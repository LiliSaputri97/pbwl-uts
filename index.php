...
<body>
      ...
      <aside>
            ...
            <header>
                  <img src="layouts/assets/img/Logomerch.jpg" class="brand">
                  <div class="user">Toko Merchandies K-POP</div>
            ...
            <nav>
                  <ul>
                        ...
                        <li>
                              ...
                              <img class="icon" src="layouts/assets/img/logout12.jpg" alt=""> Keluar
                              </a>
                        </li>
                  </ul>
            </nav>
      ...
      <main>
            ...
            <footer>
                  Copyright &copy; 2023. Lili Saputri
            </footer>
      </main>
